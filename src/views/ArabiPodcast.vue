  ...
  <div class="podcast">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="#"
            ><img src="../assets/siteLogo/logo.png" alt=""
          /></a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="navbar-nav m-auto">
              ...
              <router-link to="/OurServices" class="nav-link"
                >خدماتنا</router-link
              >
              <router-link to="/store" class="nav-link">المتجر</router-link>
              <router-link to="/blog" class="nav-link">المقالات</router-link>
              <router-link to="/pdocast" class="nav-link">بودكاست</router-link>
          ...
          <div class="imgs">
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                <div class="img-box">
                  <img src="../assets/podcastpage.png" alt="" />
                </div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="img-box">
                  <img src="../assets/podcastpage-2.png" alt="" />
                </div>
              </div>
        ...
        <div class="col-lg-9">
          <carousel
            ...
            <div class="podcast-item">
              <div class="img-box">
                <img src="../assets/girlPodcast.png" alt="" />
                <div class="time">
              ...
              <div class="item-body">
                <h3>شُعاع ينيّر دِربك للحيِاة الجامعيّة</h3>
                <p>
    ...
    <div class="JoinPodcast pods">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 cpl-12">
            <div class="podcast-item">
              <div class="img-box">
                <img src="../assets/girlPodcast.png" alt="" />
                <div class="time">
        ...
        <router-link  to="/pdocast/allPodcast" class="btn-all">الكل</router-link>
      </div>
    </div>
    ...
    <div class="podcastChannels">
      <div class="container">
        <h2>قنوات البودكاست</h2>
          ...
          >
            <div class="podcastChannel">
              <img src="../assets/podcastChannle.png" alt="" />
            </div>
...
.podcast {
  .header {
    background: linear-gradient(239.11deg, #70d644 -31.67%, #567a46 91.18%);
    height: 70vh;
    direction: rtl;
...
@media(max-width:770px){
  ...
  .podcast .header .innerHeader .imgs .col-lg-6 .img-box{
    height: 100px;
  }
