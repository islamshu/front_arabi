      ...
      <div class="container">
        ...
        <div class="form">
          <el-form
            ...
            label-position="top"
          >
            <el-form-item label="عنوان الخدمة  ">
              <el-input
                v-model="form.name"
            ...
            <el-form-item label="نوع الخدمة ">
              <el-select v-model="form.region" placeholder="اختر الخدمة">
                <el-option label="تسويقية" value="تسويقية "></el-option>
                <el-option label="تسويقية" value="تسويقية"></el-option>
              </el-select>
            </el-form-item>
            ...
            >
              ...
              <div class="el-upload__text">
                ارفاق صورة البودكاست

                <div class="el-upload__tip" slot="tip">
                  القياس: (800x470) بكسل · الحجم الأقصى: 5MB. العدد المسموح: 1
                  ملف اختيار فيديو أو صورة مصممة بشكل جيد ستظهر خدمتك بشكل
            ...
            <el-form-item label="رابط الخدمة ">
              <el-input
                v-model="form.name"
            ...
            <el-form-item label=" سعر الخدمة  ">
              <el-input
                v-model="form.name"
                placeholder="سعر الخدمة  أدخل   "
              ></el-input>
            </el-form-item>
